...
public class CardsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> getCardDetails(@Valid @RequestParam @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits") String mobileNumber){
    ...
    @Operation(
            ...
            description = "get Java version that is installed in cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "contact info details of on-call support team"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
